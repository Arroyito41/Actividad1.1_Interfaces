...
public class JuegoCaminos extends JFrame {
	...
	public JuegoCaminos() {
		...
		JLabel lblInstrucciones1 = new JLabel("Esta prueba consiste en elegir un camino, ");
		...
		JLabel lblInstrucciones2 = new JLabel("si eliges el camino equivocado mueres");
		lblInstrucciones2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblInstrucciones2.setBounds(49, 152, 274, 20);
